...
public abstract class LatticePayloadScoreFuction {
     ...
     * @see Spans
     */
    public abstract float currentSpanScore(int docId, String field, int start, int end, int width, int numPayloadsSeen, float currentScore, float currentSpanScore);
